...
proc hole::coarea {centre perpve perpvn cvect sample endrad points active} {
    ...
    for {set s 0} {$s < $n} {incr s} {
        ...
        if {$cr > $endrad} {
            ...
            # header and vmdpathfinder/hole_tcl/connolly.tcl's write_connolly_sph caller.
...
#  against the reference-build hole (see vmdpathfinder/hole_tcl/README.md)'s own CONNOLLY+sphpdb output: the duplicate
...
#  vmdpathfinder/hole_tcl/tests/sph_addend_test.sh for the measured cost on the fixture
