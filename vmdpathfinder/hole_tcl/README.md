...
it can be validated on its own; the same engine is inlined into `vmdpathfinder.tcl`
...
then copy the three binaries into `vmdpathfinder/hole_tcl/reference_bin/` (local
