...
#  the reference-build hole (see vmdpathfinder/hole_tcl/README.md)'s own -capsul -sphpdb output, see this proc's header
#  test command).
#
...
#  QC1/QC2 - confirmed directly against the reference-build hole (see vmdpathfinder/hole_tcl/README.md)'s own -capsul
#  -sphpdb output (the ADDEND block there prints 'QSS SPH S-888', not
#  'QCn SPH S-888').
#
#  Byte-identical to the reference-build hole (see vmdpathfinder/hole_tcl/README.md) on 1GRM (cpoint 0 0 4, cvect 0 0 1,
#  sample 0.5, endrad 8.0, raseed 1, capsul):
#    printf 'sphpdb refc.sph\ncoord 1GRM.pdb\nradius simple.rad\n
#      cpoint 0 0 4\ncvect 0 0 1\nsample 0.5\nendrad 8.0\nraseed 1\ncapsul\n' \
#      | the reference-build hole (see vmdpathfinder/hole_tcl/README.md)
