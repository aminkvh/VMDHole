...
body=$(awk '/^proc ::VMDPathFinder::run_tunnel_analysis /,/^}/' "$SRC")
...
set found [::VMDPathFinder::collect_frame_dirs $work]
...
set tfound [::VMDPathFinder::collect_frame_dirs [file join $work tunnels]]
...
set ::VMDPathFinder::result_frames {7}
set ::VMDPathFinder::tunnel_result_frames {}
if {[llength $::VMDPathFinder::result_frames] != 1 || [llength $::VMDPathFinder::tunnel_result_frames] != 0} {
