...
LOG="${TMPDIR:-/tmp}/vmdpathfinder_gui_reachable.$$.log"
...
# VMDPATHFINDER_GUI_DISPLAY=:1 (or any value) forces a specific display; VMDPATHFINDER_GUI_XVFB=0
...
run_gui() {   # $1 pdb, $2 het residue to require, $3 selection, $4 start point
    ...
    GUI_TEST_LOG="$LOG" VMDPATHFINDER_TCL="$DIR/../vmdpathfinder.tcl" \
