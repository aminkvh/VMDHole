...
set exe [::VMDPathFinder::_hole_tcl_exe]
set scr [::VMDPathFinder::_hole_tcl_script]
...
set base [file join [::VMDPathFinder::get_temp_base] "vmdpathfinder_pm_[pid]"]
...
foreach {tag card want_method} {capsule capsule capsule
    ...
    lassign [::VMDPathFinder::_hole_tcl_args_from_inp [file join $W hole.inp]] st args
    ...
    cd $cwd
    set p [::VMDPathFinder::parse_profile [file join $W hole_out.txt] [file join $W ref.tsv]]
    if {![dict get $p valid]} {
