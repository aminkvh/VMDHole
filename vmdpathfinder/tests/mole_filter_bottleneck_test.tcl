...
proc make_profile {length} {
    ::VMDPathFinder::Mole::spline_init sx {0.0 1.0} {0.0 100.0} 2
    ::VMDPathFinder::Mole::spline_init sy {0.0 1.0} {0.0 100.0} 2
    ::VMDPathFinder::Mole::spline_init sz {0.0 1.0} {0.0 100.0} 2
    ::VMDPathFinder::Mole::spline_init sr {0.0 1.0} {0.01 0.01} 2
...
foreach length {0.01 0.05 0.1 0.12} {
    ...
    set r0 [::VMDPathFinder::Mole::filter_bottleneck $prof 5.0 8.0 0.0]
    puts [format "  length=%.2f tolerance=0.0  -> %s" $length [expr {$r0 ? "keep" : "REJECT"}]]
    if {!$r0} { incr bad }
    set r1 [::VMDPathFinder::Mole::filter_bottleneck $prof 5.0 8.0 2.0]
