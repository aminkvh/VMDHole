...
#
# The Tcl driver is ::VMDPathFinder::Mole::find_tunnels, which mirrors mole_main.c -
...
# ------------------------------------------------------------------- build
::VMDPathFinder::Mole::read_atoms [lindex $argv 0] A
set piv [::VMDPathFinder::Mole::pivot_points A rad]
...
::VMDPathFinder::Mole::dt_build M $piv $np
::VMDPathFinder::Mole::complex_build C M $piv $rad 3.0 1.25 8
...
foreach pr $probes {
    ...
    set got [::VMDPathFinder::Mole::radius_at $qx $qy $qz $piv $rad $np 0]
